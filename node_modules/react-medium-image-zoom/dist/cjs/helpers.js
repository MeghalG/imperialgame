...
var getModalContentStyle = function (_a) {
    ...
    if (!isLoaded || isUnloading) {
        var initTransform = tslib.__spreadArrays([
            "scale(1)",
            "translate(0, 0)"
    ...
    var transform = tslib.__spreadArrays([
        "scale(" + scale + ")",
...
exports.getModalContentStyle = getModalContentStyle;
exports.getModalOverlayStyle = getModalOverlayStyle;
exports.getScale = getScale;
exports.pseudoParentEl = pseudoParentEl;
