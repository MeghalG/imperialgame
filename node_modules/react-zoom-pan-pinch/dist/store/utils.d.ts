 ...
 */
export declare const boundLimiter: (value: any, minBound: any, maxBound: any, isActive: any) => number;
/**
 ...
 */
export declare const relativeCoords: (event: any, wrapperComponent: any, contentComponent: any, panningCase: any) => {
    x: any;
    y: any;
    wrapperWidth: any;
    wrapperHeight: any;
 ...
 */
export declare const getMiddleCoords: (firstPoint: any, secondPoint: any, contentComponent: any, scale: any) => {
    x: number;
    y: number;
};
/**
 ...
 */
export declare const getMidPagePosition: (firstPoint: any, secondPoint: any) => void | {
    x: number;
    y: number;
};
/**
 ...
 */
export declare const getRelativeZoomCoords: ({ wrapperComponent, contentComponent, scale, positionX, positionY, }: {
...
export declare const handleWheelStop: (previousEvent: any, event: any, stateProvider: any) => boolean;
